...
for i = 0:(car_num-1)   % 尝试向量化
    [XYcor_i(i+1,:), XYcor_i(i+1,2)] = coorTrans(XYcor_i_1(1), XYcor_i_1(2), -car_num2pi*i);       % 内筒点坐标
    [XYcor_o(i*2+1,1), XYcor_o(i*2+1,2)] = coorTrans(XYcor_o_1(1,1), XYcor_o_1(1,2), -car_num2pi*i); % 外筒点坐标1
    [XYcor_o(i*2+2,1), XYcor_o(i*2+2,2)] = coorTrans(XYcor_o_1(2,1), XYcor_o_1(2,2), -car_num2pi*i); % 外筒点坐标2
end
% 局部坐标系 转换至 整体坐标系
