...
%%
function [iNO_end, iEL_end] = MGT_facade_tower(fileID, iNO, iEL, car_num, CoC_tower, Deg_tower, facade_tower_R, tube_innerR, levelZaxis, levelPstart, iNO_towerS_init)    %注意这里的levelPstart是1x2数组
%% NODE
