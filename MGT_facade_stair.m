...
%%
function [iNO_end, iEL_end] = MGT_facade_stair(fileID, iNO, iEL, stairColu_num, CoC_stair, Deg_stair, stairL, stairW, levelZaxis, levelPstart1, iNO_stair_init)
%% NODE
fprintf(fileID,'*NODE    ; Nodes\n');
fprintf(fileID,'; iNO, X, Y, Z\n');

% 由于幕墙每层外挑都有变化，故需要循环(或向量化)。与层数有关，与控制点定位有关，先暂定固定的数值(目前共13层，从3层起到13层)，后需参数化。
facade_stair_R = [0; 0; 7787; 6248; 5270; 4710; 4507; 4642; 5129; 6016; 7425; 9686; 16200];
